langs.en = { // Property here should match this language name
	"phrases": {
		...
		github:										"Visit SirJimmothy on GitHub",
		discord:									"SirJimmothys Discord",
		support_me:								"Support SirJimmothy",
      ...
      "Cannot change favourite room or roam long distances",
		...
		ghost_mimic_useful:				[
			...
			"Shows fake ghost orbs; These are guaranteed regardless of the number of hidden evidence items",
      ...
      "During a hunt, has a 6.66% chance each time it flickers to shapeshift into a different ghost model, and then return back to its original form. Guaranteed to occur at least once per hunt",
		...
		ghost_onryo_useful:				[
			...
			"Will hunt for every third flame extinguished, unless blocked by another lit candle. Now includes lighters",
		...
		gameplay_general_items:				[
			...
			"Ghost can flicker lights when near a light switch",
		...
		gameplay_non_evidence_items:	[
			...
			"Paramic has 40 meter range (your ears hear further), but can detect inaudible interactions",
			...
			"Once a crucifix prevents a hunt, EMF 2 will be generated and the ghost may not attempt to hunt for 25s (or 20s for a demon)",
			"Smudge sticks prevent hunts for ghosts within 6 meters. Smudges last for 90s and while multiple can be used, smudge timers cannot be stacked. Also applies during hunts",
		...
		gameplay_cursed_items_items:	[
			...
			"If the music box is &lt;5 meters from the ghost while playing, the ghost will spawn, and upon reaching the music box or after 5s, will attempt to hunt. It's possible to leave the area before this occurs to prevent the hunt, although all future hunts will have cursed hunt duration",
			...
			"Summoning circle candles require sanity to be lit; Lighting the last candle with no sanity triggers an instant hunt!",
			...
			"Weather paw wishes give temporary blindness while the weather changes: I wish for clear skies / rain / snow / sunrise / fog",
			"Ghost information wishes: I wish for knowledge (eliminates one piece of evidence but starts a hunt) / I wish for sanity (sets everyones sanity to 50% but increases sanity loss) / I wish to see the ghost (The ghost appears but a hunt begins and you are temporarily blinded) / I wish for activity (A ghost event triggers but the front door is locked for 2 minutes and the fuse box breaks)",
			"Hunt wishes: I wish the ghost was trapped (locks the ghost in its favourite room but locks you in your current room) / I wish to leave (The front door unlocks, but your speed and vision are reduced) / I wish to be safe (All lights are locked off for a short time) / I wish for life (A dead teammate has a chance to resurrect, but you have a chance to die) / I wish for anything (A random effect and consequence occurs)",
		],
